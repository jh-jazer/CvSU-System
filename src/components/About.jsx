    ...
    <div className="relative w-full h-screen z-0">
      ...
      <div className="relative py-8 px-4 sm:px-[140px] z-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-[#f0eceb] mb-6">ABOUT</h2>
          
          <div className="space-y-4">
          <div className="transition-transform transform hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-md mx-2 sm:mx-4 max-h-[200px] sm:max-h-[400px] overflow-y-scroll">
