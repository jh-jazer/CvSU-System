        ...
        <div className="absolute inset-0 bg-[#081708]/80 flex items-center justify-center z-10">
          <div className="text-center text-white space-y-6 px-4 sm:px-8">
            ...
            <div className="flex justify-center">
              <Link to="/apply">
                <button className="text-lg sm:text-2xl text-[#C61A01] font-bold bg-white py-3 sm:py-4 px-6 sm:px-8 rounded-full shadow-md hover:bg-[#C61A01] hover:text-white transition duration-300">
                  APPLY NOW
                </button>
              </Link>
            </div>
