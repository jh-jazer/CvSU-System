...
const NewsUpdates = () => {
  return (
    ...
    <div className=" top-0 left-0 w-full h-screen bg-[#081708]/50 flex items-center justify-center z-10"> 
      ...
      <div className="max-w-7xl w-full  lg:px-8 ">
        <h2 className="text-3xl font-bold text-center text-[#f0eceb] mb-6">News and Updates</h2>
        ...
        <div className=" px-4 sm:px-[100px] grid gap-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <div className="transition-transform transform hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="md:block hidden transition-transform transform hover:scale-105 hover:shadow-xl p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="text-center mt-8">
          <a href="/news" className="text-[#f0eceb] hover:underline">
